...
const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`text-red-500 -z-10 absolute bottom-0 right-0 w-48 h-48 transform translate-x-20 -translate-y-8 opacity-25`;
    ...
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>Наши локации</HeadingTitle>
          <HeadingDescription>текст</HeadingDescription>
        </HeadingInfoContainer>
        <ThreeColumn>
